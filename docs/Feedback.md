...
> Reasonable start, Coen, but does need some work. Get this done ASAP so we can move on. Don't want to be playing catch-up.
...
> Lacking is detail in places:
> - End users - see the exemplars. Need to detail what each group's specific needs / requirements are
> - Solution / functionality - should be a detailed list of all the required features (see exemplar)
> - Implications - should be 4/5 done well. 
>    - Should include Usability, with ref. to Nielsen, etc. 
>    - Does Privacy really matter with this? Others are more important, surely?
